"""
Django settings for square_boat_46768 project.
...
ROOT_URLCONF = 'square_boat_46768.urls'
...
WSGI_APPLICATION = 'square_boat_46768.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_boat_46768 API",
    "DESCRIPTION": "API documentation for square_boat_46768 App",
    "VERSION": "v1",
}
